...
type
  TFormCadastroNCM = class(TFormCadastroTEMPLATE)
    ...
    SQLTemplateMVA: TBCDField;
    SQLTemplateALIQUOTAINTERNA: TBCDField;
    SQLTemplateNCMN2ALIQNAC: TBCDField;
    SQLTemplateNCMN2ALIQIMP: TBCDField;
    ...
    SQLTemplateBASE_ICMS: TBCDField;
    SQLTemplateALIQ_ICMS: TBCDField;
    SQLTemplateBASE_ICMSST: TBCDField;
    SQLTemplateALIQ_ICMSST: TBCDField;
    SQLTemplateCSTPIS_COFINS_ENT: TStringField;
    SQLTemplateCSTPIS_COFINS: TStringField;
    SQLTemplateBASE_PIS_COFINS: TBCDField;
    SQLTemplateALIQ_PIS_REAL: TBCDField;
    SQLTemplateALIQ_PIS_PRESUMIDO: TBCDField;
    SQLTemplateALIQ_COFINS_REAL: TBCDField;
    SQLTemplateALIQ_COFINS_PRESUMIDO: TBCDField;
    ...
    Label19: TLabel;
    Label20: TLabel;
    SQLTemplateCPITN2IMPOSTOMED: TBCDField;
    SQLTemplateNFITN2IMPOSTOMED: TBCDField;
    SQLTemplateALIQESTADUAL: TBCDField;
    SQLTemplateALIQMUNICIPAL: TBCDField;
