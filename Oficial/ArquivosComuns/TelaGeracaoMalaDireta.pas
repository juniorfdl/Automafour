...
type
  TFormTelaGeracaoMalaDireta = class(TFormTelaGeralTEMPLATE)
    ...
    SQLClienteDependenteCLIEN2RENDA: TBCDField;
    SQLClienteDependenteCLIEN2LIMITECRED: TBCDField;
    ...
    SQLClienteDependenteCLIEN2CONJUGERENDA: TBCDField;
    ...
    SQLClienteDependenteCLIEN2VLRALUGUEL: TBCDField;
