inherited FormRelatorioVendasConsignadas: TFormRelatorioVendasConsignadas
  Left = 218
  Top = 137
  Caption = 'Relat'#243'rio de Vendas Consignadas'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited TblTemporaria: TTable
    TableName = 'RelVendasConsigndas.DB'
    ...
    object TblTemporariaCUPOCCONSIG: TStringField
  ...
  object SQLVendas: TRxQuery
    ...
    SQL.Strings = (
      'select'
      '  CP.CUPOA13ID, CP.CLIEA13ID, CP.EMPRICOD, CP.VENDICOD,'
      '  CP.CUPODEMIS, CP.CUPOCTIPOPADRAO, CP.CUPOCCONSIG,'
      '  CR.CTRCN2VLR, CR.CTRCN2TOTREC,'
      '  CR.CTRCN2VLR - CR.CTRCN2TOTREC as SALDO,'
      '  CL.CLIEA60RAZAOSOC'
      'from'
      '  CUPOM CP, CONTASRECEBER CR, CLIENTE CL'
      'where'
      '  CP.CUPOA13ID = CR.CUPOA13ID and'
      '  CP.CLIEA13ID = CL.CLIEA13ID and'
      '  %MEmpresa and'
      '  %MData and'
    ...
    object SQLVendasCUPOCCONSIG: TStringField
      FieldName = 'CUPOCCONSIG'
      Origin = 'DB.CUPOM.CUPOCCONSIG'
      FixedChar = True
      Size = 1
    end
    object SQLVendasCTRCN2VLR: TFloatField
      FieldName = 'CTRCN2VLR'
      Origin = 'DB.CONTASRECEBER.CTRCN2VLR'
    end
    object SQLVendasCTRCN2TOTREC: TFloatField
      FieldName = 'CTRCN2TOTREC'
      Origin = 'DB.CONTASRECEBER.CTRCN2TOTREC'
    end
    object SQLVendasSALDO: TFloatField
      FieldName = 'SALDO'
      Origin = 'DB.CONTASRECEBER.CTRCN2VLR'
    end
  ...
  object Report: TCrpe
    ...
    Version.Major = 0
    Version.Minor = 0
    ReportName = 'D:\DESENV\UnitGestao\Relatorios\Vendas Consignadas.rpt'
    Margins.Left = -1
    Margins.Right = -1
    Margins.Top = -1
    Margins.Bottom = -1
