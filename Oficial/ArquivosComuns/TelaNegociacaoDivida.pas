...
type
  TFormTelaNegociacaoDivida = class(TFormTelaGeralTEMPLATE)
    ...
    SQLDadosDupCTRCN2TOTDESCREC: TBCDField;
    SQLDadosDupCTRCN2TOTJUROREC: TBCDField;
    SQLDadosDupCTRCN2TOTMULTAREC: TBCDField;
    SQLDadosDupCTRCN2TXJURO: TBCDField;
    SQLDadosDupCTRCN2TXMULTA: TBCDField;
    SQLDadosDupCTRCN2VLR: TBCDField;
    ...
    TabelaTempCUPON2TOTITENS: TBCDField;
    TabelaTempCUPON2DESC: TBCDField;
    TabelaTempCUPON2ACRESC: TBCDField;
    ...
    SQLGeralCUPON2TOTITENS: TBCDField;
    SQLGeralCUPON2DESC: TBCDField;
    SQLGeralCUPON2ACRESC: TBCDField;
    ...
    TermorenovDividaRelCupDupCUPON2TOTITENS: TBCDField;
    TermorenovDividaRelCupDupCUPON2DESC: TBCDField;
    TermorenovDividaRelCupDupCUPON2ACRESC: TBCDField;
    ...
    Label17: TLabel;
    SQLDadosDupCTRCN2TOTREC: TBCDField;
