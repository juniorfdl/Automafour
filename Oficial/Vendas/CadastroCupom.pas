...
type
  TFormCadastroCupom = class(TFormCadastroTEMPLATE)
    ...
    Label46: TLabel;
    DBEdit43: TDBEdit;
    SQLTemplateCUPON2VLRPIS: TBCDField;
    SQLTemplateCUPON2VLRCOFINS: TBCDField;
    SQLItensTemp: TRxQuery;
    SQLItensTempCUPOA13ID: TStringField;
    SQLItensTempCPITN2VLRPIS: TBCDField;
    SQLItensTempCPITN2VLRCOFINS: TBCDField;
    ...
    SQLCupomItemM3_LARGURA: TBCDField;
    SQLCupomItemM3_COMPRI: TBCDField;
    SQLCupomItemM3_ESPESSURA: TBCDField;
