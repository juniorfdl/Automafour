...
type
  TFormTelaTransferencia = class(TFormTelaGeralTEMPLATE)
    ...
    SQLTranferenciaItemTRITN3QTDEENVIADA: TBCDField;
    SQLTranferenciaItemTRITN3QTDERECEBIDA: TBCDField;
    ...
    tblTransferenciaDivergenciasTRITN3QTDEENVIADA: TBCDField;
    tblTransferenciaDivergenciasTRITN3QTDERECEBIDA: TBCDField;
    ...
    SQLTranferenciaItemTRITN3VLRCUSTO: TBCDField;
    ...
    SQLNotaFiscalNOFIN2PERCCOFINS: TBCDField;
    SQLNotaFiscalNOFIN2PERCCONTRSOCIAL: TBCDField;
    SQLNotaFiscalNOFIN2PERCINSS: TBCDField;
    SQLNotaFiscalNOFIN2PERCIR: TBCDField;
    SQLNotaFiscalNOFIN2PERCISSQN: TBCDField;
    SQLNotaFiscalNOFIN2PERCMAODEOBRA: TBCDField;
    SQLNotaFiscalNOFIN2PERCMATERIAL: TBCDField;
    SQLNotaFiscalNOFIN2PERCPIS: TBCDField;
    SQLNotaFiscalNOFIN3VLRCOFINS: TBCDField;
    SQLNotaFiscalNOFIN3VLRCONTRSOCIAL: TBCDField;
    SQLNotaFiscalNOFIN3VLRINSS: TBCDField;
    SQLNotaFiscalNOFIN3VLRIR: TBCDField;
    SQLNotaFiscalNOFIN3VLRMAODEOBRA: TBCDField;
    SQLNotaFiscalNOFIN3VLRMATERIAL: TBCDField;
