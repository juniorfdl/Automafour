...
type
  TFormTelaDadosOSPedidoVenda = class(TForm)
    ...
    SQLOSItemOSITN2VLRITEM: TBCDField;
    SQLOSItemOSITN2VLRDESC: TBCDField;
    SQLOSItemOSITN2PERCDESC: TBCDField;
    DsMarterTamplate: TDataSource;
    SQLProdutoPRODN3VLRVENDA: TBCDField;
    SQLOSItemOSITTPROBLEMA: TMemoField;
    DBMemo2: TDBMemo;
    Label1: TLabel;
    SQLOSItemOSITN2VLRTOTITEM: TBCDField;
    SQLOSOSN2VLRSERVICO: TBCDField;
    SQLOSOSN2VLRDESC: TBCDField;
    SQLOSOSN2PERCDESC: TBCDField;
    SQLOSOSN2VLRTOTAL: TBCDField;
