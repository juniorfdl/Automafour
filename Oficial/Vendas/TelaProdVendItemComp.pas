...
type
  TFormTelaProdVendItemComp = class(TForm)
    ...
    SQLComposicaoProdutoPRODN3QTDE: TBCDField;
    SQLComposicaoProdutoPENDENTE: TStringField;
    SQLComposicaoProdutoREGISTRO: TDateTimeField;
    SQLComposicaoProdutoPRODN3VLRTOTAL: TBCDField;
    ...
    SQLComposicaoProdutoPRODN3VLRVENDA: TBCDField;
    SQLSomaTOTALQTDE: TBCDField;
    SQLSomaTOTALVALOR: TFloatField;
    SQLSomaTOTALPERCDESC: TBCDField;
