  ...
  inherited;
   ...
   begin
      ...
      begin
         ...
         RxTableDESCR.asstring  := Trim(edtDescricao.text)+' - � vista';
         RxTableEMI.asDateTime  := StrToDate(edtEmissao.Text);
         RxTable.Post;
...
begin
  ...
  if ComboEmpresa.KeyValue = null then
    begin
      ShowMessage('� necess�rio informar uma empresa');
      ComboEmpresa.SetFocus;
    end;
  if ComboFornecedor.KeyValue = null then
    begin
      ShowMessage('� necess�rio informar um Fornecedor');
      ComboFornecedor.SetFocus;
    end;
  if ComboTipoDoc.KeyValue = null then
    begin
      ShowMessage('� necess�rio informar um Tipo de Documento');
      ComboTipoDoc.SetFocus;
    end;
  if ComboPortador.KeyValue = null then
    begin
      ShowMessage('� necess�rio informar um Portador');
      ComboPortador.SetFocus;
    end;
  if EditNFNro.Text = '' then
    begin
      ShowMessage('� necess�rio informar o N�mero da Nota');
      EditNFNro.SetFocus;
    end;
  RxTable.First;
  VlrSoma := 0;
