...
begin
  ...
  if not FileExists('TabelaIbptaxRS16.2.A.csv') then
    begin
      ShowMessage('ERRO: N�o foi localizado a arquivo TabelaIbptaxRS16.2.A.csv, na Gestao');
      Abort;
      Exit;
    end
  else
    begin
      try
        ...
        ShowMessage('ERRO: N�o foi poss�vel abrir o arquivo TabelaIbptaxRS16.2.A.csv, na Gestao');
        Abort;
        Exit;
      end;
      Reset(Texto);
...
begin
  ...
  if not FileExists('..\Super Tributario.csv') then
    begin
      ShowMessage('ERRO: N�o foi localizado a arquivo Super Tributario.csv, na Gestao');
      Abort;
      Exit;
    end;
