...
type
  TFormCadastroClienteVeiculos = class(TFormCadastroTEMPLATE)
    ...
    SQLPlanosRecebimentoPLRCN2TXJURO: TBCDField;
    SQLPlanosRecebimentoPLRCN2TXMULTA: TBCDField;
    SQLPlanosRecebimentoPLRCN2TXCRED: TBCDField;
    SQLPlanosRecebimentoPLRCN2PERCDESC: TBCDField;
    ...
    SQLPlanosRecebimentoPLRCN2PERCENTR: TBCDField;
    SQLPlanosRecebimentoPLRCN2DESC: TBCDField;
    ...
    SQLPlanosRecebimentoPLRCN2PERCACRESC: TBCDField;
    SQLPlanosRecebimentoPLRCCIMPDESCRNF: TStringField;
    SQLPlanosRecebimentoPLRCN5FATOR: TBCDField;
    SQLPlanosRecebimentoPLRCN5FATORPARC: TBCDField;
    SQLPlanosRecebimentoPLRCFATCASH: TStringField;
    SQLPlanosRecebimentoPLRCN2PERCJURDIA: TBCDField;
    ...
    SQLTemplateVICLN2KMATUAL: TBCDField;
