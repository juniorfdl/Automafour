unit RelatorioEstoquePorGradePorProduto;
...
type
  TFormRelatorioEstoquePorGradePorProduto = class(TFormRelatorioTEMPLATE)
...
var
  FormRelatorioEstoquePorGradePorProduto: TFormRelatorioEstoquePorGradePorProduto;
...
procedure TFormRelatorioEstoquePorGradePorProduto.ExecutarBtnClick(
  Sender: TObject);
Var
...
begin
  ...
  While Not SQLProduto.Eof Do
    Begin
      ...
      SQLProduto.Next;
    End;
  Report.ReportName := DM.SQLConfigGeralCFGEA255PATHREPORT.Value + '\Estoque por Grade Por Produto.rpt' ;
  Report.ReportTitle       := 'Relatório Posição de Estoque por Grade Por Produto' ;
  Report.WindowStyle.Title := 'Relatório Posição de Estoque por Grade Por Produto' ;
...
Procedure TFormRelatorioEstoquePorGradePorProduto.VerificaGrade(Grade:Integer);
Var
  I:Integer;
Begin
...
procedure TFormRelatorioEstoquePorGradePorProduto.FormCreate(
  Sender: TObject);
begin
  inherited;
  SQLGrupo.Open;
...
procedure TFormRelatorioEstoquePorGradePorProduto.EditGradeExit(
  Sender: TObject);
begin
  inherited;
...
procedure TFormRelatorioEstoquePorGradePorProduto.ComboGrupoChange(
  Sender: TObject);
begin
  inherited;
...
procedure TFormRelatorioEstoquePorGradePorProduto.ComboSubGrupoChange(
  Sender: TObject);
begin
  inherited;
...
procedure TFormRelatorioEstoquePorGradePorProduto.ComboReferKeyDown(
