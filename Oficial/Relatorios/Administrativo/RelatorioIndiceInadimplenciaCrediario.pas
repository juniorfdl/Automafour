...
type
  TFormRelatorioIndiceInadimplenciaCrediario = class(TFormRelatorioTEMPLATE)
    ...
    SQLContasAReceberCTRCN2VLR: TBCDField;
    SQLContasAReceberCTRCN2TXJURO: TBCDField;
    SQLContasAReceberCTRCN2TXMULTA: TBCDField;
    SQLContasAReceberCTRCN2TOTMULTACOBR: TBCDField;
    SQLContasAReceberCTRCN2TOTREC: TBCDField;
    ...
    SQLContasRecebidasCTRCN2VLR: TBCDField;
    SQLContasRecebidasCTRCN2TXJURO: TBCDField;
    SQLContasRecebidasCTRCN2TXMULTA: TBCDField;
    SQLContasRecebidasCTRCN2TOTMULTACOBR: TBCDField;
    SQLContasRecebidasCTRCN2TOTREC: TBCDField;
