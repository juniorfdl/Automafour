inherited FormRelatorioVendasColecao: TFormRelatorioVendasColecao
  ...
  object SQLVendaColecao: TRxQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'select'
      '  PRODUTO.COLEICOD,'
      ...
      'from'
        ...
        '   left outer join COLECAO COLECAO on COLECAO.COLEICOD = PRODUTO' +
        '.COLEICOD'
    ...
    Left = 424
    Top = 5
    object SQLVendaColecaoCOLEICOD: TIntegerField
      FieldName = 'COLEICOD'
    end
    object SQLVendaColecaoCOLEA60DESCR: TStringField
      FieldName = 'COLEA60DESCR'
      FixedChar = True
      Size = 60
    end
