...
type
  TFormRelatorioNotasCompra = class(TFormRelatorioTEMPLATE)
    ...
    SQLNotaComprasNOCPN3VLRICMS: TFloatField;
    SQLNotaComprasNOCPN3VLRIPI: TFloatField;
    SQLNotaComprasNOCPN3VLRTOTNOTA: TFloatField;
    ...
    TblTemporariaNOCPN3VLRICMS: TFloatField;
    TblTemporariaNOCPN3VLRIPI: TFloatField;
    TblTemporariaNOCPN3VLRTOTNOTA: TFloatField;
    ...
    SQLNotaComprasNOCPN3VLRBASCALICM: TFloatField;
    TblTemporariaNOCPN3VLRBASCALICM: TFloatField;
    SQLCFOP: TRxQuery;
    ...
    SQLComprasItemNOCIN3VLRICMS: TFloatField;
    SQLComprasItemNOCIN3PERCICMS: TFloatField;
    SQLComprasItemQTDE: TFloatField;
    SQLComprasItemNOCIN3VLREMBAL: TFloatField;
    TblTempIcmsALIQUOTA: TFloatField;
    SQLComprasItemNOCIN3VLRSUBST: TFloatField;
    SQLComprasItemNOCIN2PERCSUBST: TFloatField;
