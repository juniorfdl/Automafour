inherited FormRelatorioClienteLimiteCreditoExcedido: TFormRelatorioClienteLimiteCreditoExcedido
  ...
  inherited TblTemporaria: TTable
    ...
    object TblTemporariaLIMITEORIGINAL: TFloatField
      FieldName = 'LIMITEORIGINAL'
    end
    object TblTemporariaCOMPRASPRAZO: TFloatField
      FieldName = 'COMPRASPRAZO'
    end
    object TblTemporariaLIMITEFINAL: TFloatField
      FieldName = 'LIMITEFINAL'
    end
  end
  object SQLClienteGeral: TRxQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'Select'
      '  CLIEA13ID,'
    ...
    Left = 421
    Top = 5
    object SQLClienteGeralCLIEA13ID: TStringField
      FieldName = 'CLIEA13ID'
      Origin = 'DB.CLIENTE.CLIEA13ID'
      FixedChar = True
      Size = 13
    end
    object SQLClienteGeralCLIEA60RAZAOSOC: TStringField
      FieldName = 'CLIEA60RAZAOSOC'
      Origin = 'DB.CLIENTE.CLIEA60RAZAOSOC'
      FixedChar = True
      Size = 60
