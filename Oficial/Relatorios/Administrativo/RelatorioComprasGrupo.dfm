inherited FormRelatorioComprasGrupo: TFormRelatorioComprasGrupo
  Left = 206
  Top = 132
  Caption = 'Relat'#243'rio de Compras Por Grupo'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object SQLCompraGrupo: TRxQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'select'
      '  PRODUTO.GRUPICOD,'
    ...
    Left = 424
    Top = 5
    object SQLCompraGrupoGRUPICOD: TIntegerField
      FieldName = 'GRUPICOD'
    end
    object SQLCompraGrupoGRUPA60DESCR: TStringField
      FieldName = 'GRUPA60DESCR'
      FixedChar = True
      Size = 60
    end
    object SQLCompraGrupoQTDETOTAL: TFloatField
      FieldName = 'QTDETOTAL'
    end
    object SQLCompraGrupoTOTAL: TFloatField
      FieldName = 'TOTAL'
    end
  end
  object Report: TCrpe
