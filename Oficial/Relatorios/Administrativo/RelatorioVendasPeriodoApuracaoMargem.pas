...
type
  TFormRelatorioVendasPeriodoApuracaoMargem = class(TFormRelatorioTEMPLATE)
    ...
    SQLNotasFiscaisNOFIN2VLRPRODUTO: TBCDField;
    SQLNotasFiscaisTOTAL: TBCDField;
    SQLNotasFiscaisNOFIN2VLRDESC: TBCDField;
    ...
    SQLNotasFiscaisVLRLUCRO: TBCDField;
    SQLNotasFiscaisDOC: TIntegerField;
    SQLNotasFiscaisCOMISSAO: TBCDField;
    ...
    SQLVendasNOFIN2VLRPRODUTO: TBCDField;
    SQLVendasTOTAL: TFloatField;
    SQLVendasNOFIN2VLRDESC: TBCDField;
    ...
    SQLVendasVLRLUCRO: TBCDField;
    SQLVendasDOC: TIntegerField;
    SQLVendasCOMISSAO: TBCDField;
