...
type
  TFormRelatorioPontoDeEquilibrio = class(TFormRelatorioTEMPLATE)
    ...
    SQLEmpresaCustoEMCTN2VALOR: TBCDField;
    SQLEmpresaCustoEMCTN2PERC: TBCDField;
    ...
    SQLCupomVLRCUPOM: TBCDField;
    SQLCupomVLRICMS: TBCDField;
    SQLCupomCUPODEMIS: TDateTimeField;
    SQLCustoMedioNotaCUSTOMEDIO: TBCDField;
    SQLCustoMedioNotaNOFIDEMIS: TDateTimeField;
    SQLCustoMedioCupomCUSTOMEDIO: TBCDField;
