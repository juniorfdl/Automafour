...
type
  TFormRelatorioVendasPeriodo = class(TFormRelatorioTEMPLATE)
    ...
    SQLVendasCUPON2ACRESC: TBCDField;
    SQLVendasTOTAL: TFloatField;
    SQLVendasCUPON3BONUSTROCA: TBCDField;
    SQLVendasNROITENS: TBCDField;
    ...
    SQLVendasConsigCUPON2TOTITENS: TBCDField;
    SQLVendasConsigCUPON2ACRESC: TBCDField;
    SQLVendasConsigCUPON2DESC: TBCDField;
    ...
    SQLRecebimentosRECEN2VLRRECTO: TBCDField;
    SQLRecebimentosRECEN2VLRJURO: TBCDField;
    SQLRecebimentosRECEN2VLRMULTA: TBCDField;
    SQLRecebimentosRECEN2DESC: TBCDField;
    SQLRecebimentosRECEN2MULTACOBR: TBCDField;
    ...
    SQLNotasCUPON2TOTITENS: TBCDField;
    SQLNotasCUPON2ACRESC: TFloatField;
    SQLNotasCUPON2DESC: TBCDField;
    SQLNotasTOTAL: TFloatField;
    SQLNotasNROITENS: TBCDField;
