...
type
  TFormRelatorioProdutosComprados = class(TFormRelatorioTEMPLATE)
    ...
    SQLComprasPRODN2ALIQPIS: TFloatField;
    SQLComprasPRODN2ALIQCOFINS: TFloatField;
    TblTemporariaPRODN2ALIQPIS: TFloatField;
    TblTemporariaPRODN2ALIQCOFINS: TFloatField;
    ...
    SQLComprasNOCIN3CAPEMBAL: TFloatField;
    TblTemporariaNOCIN3CAPEMBAL: TFloatField;
