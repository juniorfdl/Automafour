...
type
  TFormRelatorioPosicaoDiariaEstoque = class(TFormRelatorioTEMPLATE)
    ...
    SQLProdutoSaldoDiaPRODN3VLRVENDA: TFloatField;
    SQLProdutoSaldoDiaPRODN3VLRCOMPRA: TFloatField;
    SQLProdutoSaldoDiaPRODN3VLRCUSTO: TFloatField;
    SQLProdutoSaldoDiaPRODN3VLRCUSTOMED: TFloatField;
    SQLProdutoSaldoDiaPRODN3VLRCOMPRAMED: TFloatField;
    ...
    TblTemporariaPSDIN3QTDE: TFloatField;
    ...
    TblTemporariaPRODN3VLRCOMPRAMED: TFloatField;
