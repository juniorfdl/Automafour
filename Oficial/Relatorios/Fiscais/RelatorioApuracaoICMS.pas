...
type
  TFormRelatorioApuracaoICMS = class(TFormRelatorioTEMPLATE)
    ...
    SQLNotaCompraNOCPN3SOMAITENS: TFloatField;
    SQLNotaCompraNOCPN3TOTITENS: TFloatField;
    SQLNotaCompraNOCPN3TOTDESC: TFloatField;
    SQLNotaCompraNOCPN3VLRTOTNOTA: TFloatField;
    SQLNotaCompraNOCPN3VLRBASCALICM: TFloatField;
    SQLNotaCompraNOCPN3VLRICMS: TFloatField;
    SQLNotaCompraNOCPN3VLRBCICMSSUB: TFloatField;
    SQLNotaCompraNOCPN3VLRICMSSUB: TFloatField;
    SQLNotaCompraNOCPN3VLRFRETE: TFloatField;
    SQLNotaCompraNOCPN3VLRSEGURO: TFloatField;
    SQLNotaCompraNOCPN3VLROUTRADESP: TFloatField;
    SQLNotaCompraNOCPN3VLRIPI: TFloatField;
    SQLNotaCompraNOCPN3VLRDESC: TFloatField;
    ...
    SQLIcmsICMSN2PERCREDUCAO: TFloatField;
    ...
    SQLNotaCompraNOCPN3PERCICMSFRET: TFloatField;
    ...
    SQLCupomFRETE: TFloatField;
    SQLCupomICMSFRETE: TFloatField;
    SQLCupomCUPON2BASEICMS: TFloatField;
    SQLCupomCUPON2VLRICMS: TFloatField;
    SQLCupomVLRIPI: TFloatField;
