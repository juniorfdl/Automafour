...
type
  TFormRelatorioPedidoVenda = class(TFormRelatorioTEMPLATE)
    ...
    TblTemporariaPDVDN2VLRFRETE: TFloatField;
    ...
    TblTemporariaPDVDN2VLRDESC: TFloatField;
    TblTemporariaPDVDN2TOTPROD: TFloatField;
    TblTemporariaPDVDN2TOTPED: TFloatField;
    TblTemporariaPDVDTOBS: TStringField;
    TblTemporariaPDVDN2VLRDESCPROM: TFloatField;
    ...
    TblTemporariaPDVDN2VLRMONTAGEM: TFloatField;
    TblTemporariaPDVDN2VLRIMPERMEAB: TFloatField;
