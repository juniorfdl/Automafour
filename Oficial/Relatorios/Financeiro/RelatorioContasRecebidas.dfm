inherited FormRelatorioContasRecebidas: TFormRelatorioContasRecebidas
  Left = 272
  Top = 118
  Caption = 'Relatório de Contas Recebidas'
  ClientHeight = 556
  ClientWidth = 806
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited ScrollBox: TScrollBox
    ...
    inherited PanelCentro: TPanel
      ...
      object GroupBox3: TGroupBox
        ...
        Width = 407
        Height = 41
        Caption = ' Contas Emitidas no Período '
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Tahoma'
  ...
  object SQLPlanoContas: TRxQuery
    ...
    SQL.Strings = (
      ...
      'Where PLCTCTIPOSALDO = ''C'' and PLCTCANALSINT = ''A'''
  ...
  object SQLCupomNumerario: TRxQuery
    ...
    SQL.Strings = (
      ...
      '  CLIENTE.CLIEA60RAZAOSOC,'
      '  cast(''ENTRADA'' as char(30)) as TPDCA60DESCR,'
      '  cast(''CAIXA''   as char(60)) as PORTA60DESCR'
      'from'
