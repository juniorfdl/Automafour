...
type
  TFormTelaContagemManual = class(TForm)
    ...
    SQLInventarioINVICONTAGEM1: TBCDField;
    SQLInventarioINVICONTAGEM2: TBCDField;
    SQLInventarioINVICONTAGEM3: TBCDField;
    ...
    SQLExcluirInventarioINVICONTAGEM1: TBCDField;
    SQLExcluirInventarioINVICONTAGEM2: TBCDField;
    SQLExcluirInventarioINVICONTAGEM3: TBCDField;
    ...
    SQLTotalContagemTOTAL1: TBCDField;
    SQLTotalContagemTOTAL2: TBCDField;
    SQLTotalContagemTOTAL3: TBCDField;
    Label15: TLabel;
